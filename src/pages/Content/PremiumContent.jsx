...
const PremiumContent = () => {
  ...
  const categories = [
    { id: 'all', label: 'Todo', icon: <Crown className="w-4 h-4" /> },
    { id: 'programs', label: 'Programas', icon: <Target className="w-4 h-4" /> },
    { id: 'workouts', label: 'Entrenamientos', icon: <Dumbbell className="w-4 h-4" /> },
    { id: 'nutrition', label: 'Nutrición', icon: <Award className="w-4 h-4" /> },
    { id: 'recovery', label: 'Recuperación', icon: <Zap className="w-4 h-4" /> }
  ];
  ...
  const benefits = [
    {
      ...
      title: 'Videos en 4K',
      description: 'Contenido en ultra alta definición'
    },
    {
      icon: <Target className="w-6 h-6" />,
      title: 'Planes Personalizados',
      description: 'Adaptados a tus objetivos específicos'
    },
    {
      icon: <Award className="w-6 h-6" />,
      title: 'Certificaciones',
      description: 'Obtén reconocimiento por tu progreso'
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: 'Seguimiento Avanzado',
      description: 'Analytics detallados de tu rendimiento'
    }
  ];
